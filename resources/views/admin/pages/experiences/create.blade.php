<x-admin-app-layout :title="'Experience Add'">
    <div class="card card-flash">
        ...
        <div class="card-body pt-0">
            <!--begin::Form-->
            <form class="form" action="{{ route('admin.experiences.store') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="quote" type="text" name="quote" :value="old('quote')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="starting_year" type="number" name="starting_year" :value="old('starting_year')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="end_year" type="number" name="end_year" :value="old('end_year')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="role" type="text" name="role" :value="old('role')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="organization" type="text" name="organization" :value="old('organization')"
