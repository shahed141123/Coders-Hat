<x-admin-app-layout :title="'Team Member Update'">
    <div class="card card-flash">
        <div class="card-body scroll-y mx-5 mx-xl-15 my-7">
            <form class="form" method="POST" action="{{ route('admin.team-member.update', $teamMember->id) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="designation" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="designation" :value="old('designation', $teamMember->designation)" placeholder="Enter Designation"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="instagram" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="instagram" :value="old('instagram', $teamMember->instagram)"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="youtube" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="youtube" :value="old('youtube', $teamMember->youtube)" placeholder="Enter YouTube Channel URL"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="tiktok" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="tiktok" :value="old('tiktok', $teamMember->tiktok)" placeholder="Enter TikTok Profile URL"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="portfolio" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="portfolio" :value="old('portfolio', $teamMember->portfolio)" placeholder="Enter Portfolio URL"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.textarea id="biography" class="form-control-solid mb-3 mb-lg-0" name="biography"
                            placeholder="Enter Biography">{{ old('biography', $teamMember->biography) }}</x-metronic.textarea>
                    </div>
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.input id="location" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="location" :value="old('location', $teamMember->location)" placeholder="Enter Location"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-7">
                        ...
                        <x-metronic.input id="start_date" type="date" class="form-control-solid mb-3 mb-lg-0"
                            name="start_date" :value="old('start_date', $teamMember->start_date)"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-7">
                        ...
                        <x-metronic.input id="language" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="language" :value="old('language', $teamMember->language)" placeholder="List Languages Spoken"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.textarea id="skills" class="form-control-solid mb-3 mb-lg-0" name="skills"
                            placeholder="List Skills (comma separated)">{{ old('skills', $teamMember->skills) }}</x-metronic.textarea>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.textarea id="awards" class="form-control-solid mb-3 mb-lg-0" name="awards"
                            placeholder="List Awards or Recognition">{{ old('awards', $teamMember->awards) }}</x-metronic.textarea>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.textarea id="interests" class="form-control-solid mb-3 mb-lg-0" name="interests"
                            placeholder="List Interests or Hobbies">{{ old('interests', $teamMember->interests) }}</x-metronic.textarea>
                    </div>
                </div>
